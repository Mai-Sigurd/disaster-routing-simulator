...
def save_input_data(self: InputData, osm_geopandas_json: str, danger_zones_geopandas_json: str, interval: int, chunks: int, worldpop: bool, population_number: int, worldpop_filepath: str) -> None:
