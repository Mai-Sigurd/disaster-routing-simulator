...
def add_input_fields_pick_area(parent: str) -> list[gui_type]:
    ...
    t3 = _add_population_input_field(
        ...
        desc2="Either download a worldpop tiff file and input the filepath relative to the Disaster-routing-simulator folder \n or input a population number which will be evenly distributed across the dangerzone",
        tag=POPULATION,
        types=[
            TIFF_FILE,
            POPULATION_NUMBER,
