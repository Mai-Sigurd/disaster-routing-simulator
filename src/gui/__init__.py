...
def _open_gui(error_message: str = "") -> None:
    ...
    with dpg.theme() as white_theme:
        with dpg.theme_component(dpg.mvAll):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (245, 245, 245), category=dpg.mvThemeCat_Core)  # input fields, combo, etc.
            ...
            dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (240, 240, 240),
                                category=dpg.mvThemeCat_Core)  # Light gray background
            dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (230, 230, 230),
                                category=dpg.mvThemeCat_Core)  # Slightly darker on hover
            dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (220, 220, 220),
                                category=dpg.mvThemeCat_Core)  # Even darker when active
            dpg.add_theme_color(dpg.mvThemeCol_Border, (180, 180, 180), category=dpg.mvThemeCat_Core)  # Visible border
