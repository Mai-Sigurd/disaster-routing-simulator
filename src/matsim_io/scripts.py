...
def move_dashboards(output_dirs: list[str]) -> None:
    """
    Move every dashboard-2.yaml file in the given directories up to the MATSim data directory.
    :param output_dirs: List of subdirectories in the MATSim data directory.
    """

    for i, output_dir in enumerate(output_dirs, start=1):
