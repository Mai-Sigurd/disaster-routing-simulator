...
def population_data_from_tiff(tiff_file_name: str, geo_file_name: str, G: nx.MultiDiGraph) -> gpd.GeoDataFrame:
    """
    ...
    """
    save_tiff_population_to_geojson(tiff_file_name=tiff_file_name, geo_file_name=geo_file_name, G=G, maximum_distance_to_node=100)
    return population_data_from_geojson(geo_file_name)
    

def population_data_from_number(danger_zone: gpd.GeoDataFrame, population_number: int) -> gpd.GeoDataFrame:
    """
